...
psi_in = onp.zeros(16)
psi_in[-1] = 1
psi_in = jnp.array(psi_in, dtype=jnp.complex64)
...
no_povms, no_fields, dof = 16, me.no_fields, me.dof
...
onp.save('../results/four-body2/four-body-array2-{}.npy'.format(index), numpy_array)
